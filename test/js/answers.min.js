...
D:{12:{type:"Your D Type is Trusted.",text:"You prefer trusted, proven methods that are established as winners. You prefer to have a high level of certainty in your work methods.\n\nYou may prefer using another expert\u2019s system to start off with, at least while finding your feet. \n\nThis could mean certifying under another expert or it could mean using a franchise, or multilevel marketing system."},10:{type:"Your D Type is Pragmatic.",text:"You like the reassurance of well-tested approaches but you also like to be able to add in your own expertise or a touch of what\u2019s happening now.\n\nYou take a pragmatic approach, respecting what has come before but also bringing in some new elements."},
8:{type:"Your D Type is Agile.",text:"You prefer to stay flexible. While you respect your predecessors in your field you know there is much to be developed and improved. You feel excited about finding new ways for progress to be made.\n\nYou bring a fresh, yet measured approach to the marketplace."},6:{type:"Your D Type is Innovative.",text:"You love to operate at the cutting edge and uncover new exciting approaches and techniques. You would love your work to at the forefront of its field and it breaking new ground.\n\nYou enjoy bringing completely new, innovative approaches to the marketplace."}},
E:{12:{type:"Your E Type is Torch-bearer.",text:"You are a leader. You prefer guiding people on how tasks should be done as opposed to doing the work. You natural tendency is to take charge.\n\nThe business idea that suits you best will center around being an advisor as opposed to implementing work for other people. This could be in the field of coaching or consulting."},10:{type:"Your E Type is Architect.",text:"You are a hands-on leader. You lay down the framework and lead others using practical methods how to get results.\n\nThe business idea that suits you best will center around being an advisor but also getting down to earth and showing how the practicalities work."},
