...
10:{type:"Your D Type is Pragmatic.",image:"images/D-Pragmatic.png",text:"You like the reassurance of well-tested approaches but you also like to be able to add in your own expertise, or a touch of what's happening now.\n\nYou take a pragmatic approach, respecting what has come before, but also bringing in some new elements."},8:{type:"Your D Type is Agile.",image:"images/D-Agile.png",text:"You prefer to stay flexible. While you respect the predecessors in your field, you know there is much to be developed and improved. You feel excited about finding new ways for progress to be made.\n\nYou bring a fresh, yet measured approach to the marketplace."},
6:{type:"Your D Type is Innovative.",image:"images/D-Innovative.png",text:"You love to operate at the cutting edge and uncover new exciting approaches and techniques. You would love your work to at the forefront of its field and breaking new ground.\n\nYou enjoy bringing completely new, innovative approaches to the marketplace."}},E:{desc:"Your E Type refers to your Execution Type. It describes your role in relationship with your clients, whether you prefer to execute (as in do the work!) or lead.",
